...
This repo contains the official implementation of the 2D bottom-up human pose estimation model from the paper [A Fusion Model based on CNN-Vision Transformer for HumanPose Estimation (KSC 2022)](https://drive.google.com/file/d/1sC1Li9IQlDmLiRUhiMM4VQVLzrb6uXsS/view?usp=sharing), by Sehee Kim and Junhee Lee.
